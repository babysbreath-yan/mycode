        ...
        <header class="container">
            <div class="head-right">
                <ul class="top-nav">
                    ...
                    <li class="checkout"><a href="zhifu.jsp">结算</a></li>
                    <li class="log-in"><a href="login.jsp" title="登录">注册|登录</a></li>
                </ul>
                    ...
                    <div class="cart-block">
                        ...
                        <div id="minicart" class="remain_cart" style="display: none;">
                            ...
                            <ol>
                                ...
                                <li>
                                    <div class="total-block">总计:<span>￥ 198.00</span></div>
                                    <a href="zhifu.jsp"class="orange-btn">结算</a>
                                    <div class="clear"></div>
                                </li>
                            </ol>
                        </div>
            ...
            <nav id="smoothmenu1" class="ddsmoothmenu mainMenu">
                <ul id="nav">
                    ...
                    <li class=""><a href="category.jsp">全部商品</a></li>

                    <li class=""><a href="show_message.jsp">留言板</a></li>
                </ul>
            </nav>
            ...
            <div class="mobMenu">
                ...
                <div id="menuInnner" style="display:none;">
                    <ul class="accordion">
                        <li class="active"><a href="index.jsp">首页</a></li>
                        <li class="parent"><a href="category.jsp">全部商品</a> </li>
            ...
            <div class="main">
                ...
                <div class="account-login">
                    <div class="col-1 new-users">
                        <div class="content">
                            <h2>新用户</h2>
                            <p>通过与我们的商店创建一个帐户，我们有更多优惠活动将第一时间通知您。同时您可以存储多个送货地址，让您结算过程更方便。</p>
                        </div>
                    </div>

                    <div class="col-2 registered-users">
                        <form action="userServlet?tp=login" method="post">
                            <div class="content">
                                <h2>客户登录</h2>
                                <p>已经注册过？请直接登录</p>
                                <ul class="form-list">
                            ...
                            <div class="buttons-set">
                                ...
                                <a class="orange-btn"><span><span><input type="submit" value="登录"/></span></span></a>
                                <div class="clear"></div>
                            </div>
                        </form>
                    </div>
                    <div class="col-2 registered-users">
                        <form action="userServlet?tp=register" method="post">
                            <div class="content">
                                <h2>客户注册</h2>
                                <ul class="form-list">
                                    <li>
                            ...
                            <div class="buttons-set">
                                <a class="orange-btn"><span><span><input type="submit" value="注册"/></span></span></a>
                            </div>
                        </form>
                    </div>
                    <div class="clear"></div>
