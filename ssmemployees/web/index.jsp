...
<div class="mainContainer big container"><!--主要内容区-->
  ...
  <div class="header-wrapper">
    <c:if test="${users!=null}">
      <label>欢迎用户${users.userName}登录</label>
    </c:if>
    <header class="container">
      ...
      <nav id="smoothmenu1" class="ddsmoothmenu mainMenu">
        ...
        <ul id="nav">
          ...
          <li ><a href="clothesServlet?tp=clothesAll">全部商品</a></li>
          <li><a href='<%=request.getContextPath()%>/message/show'>留言板</a></li>
        </ul>
      </nav>
    ...
    <div class="content-container container">
      ...
      <div class="feature-block">
        <ul id="mix" class="product-grid">
          <c:forEach items="${clothesListRm}" var="clothes">
            <li><!--第一个-->
              <a href="clothesServlet?tp=clothesQueryOne&clothesId=${clothes.clothesId}">
                <div class="pro-img"><img title="Freature Product" alt="Freature Product" src="${clothes.clothesPct}" /></div>
                <div class="pro-hover-block">
                  <!--“热卖商品”和“新品上架”区别：鼠标经过-->
                  <h4 class="pro-name">${clothes.clothesName}</h4>
      ...
      <div class="new-product-block">
        <ul class="product-grid" style="float: left">
          <c:forEach items="${clothesListXp}" var="clothes">
          <li style="width: 22%">
            <a href="clothesServlet?tp=clothesQueryOne&clothesId=${clothes.clothesId}">
              <div class="pro-img">
                <img title="Freature Product" alt="Freature Product" src="${clothes.clothesPct}" />
              </div>
