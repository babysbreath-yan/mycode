					...
					<div class="ibox-content">
						<form method="post" class="form-horizontal" id="commentForm" action="<%=path%>/empservlet?state=toupdate">
							...
							<div class="form-group">
								...
								<div class="col-sm-7">
									<input type="text" class="form-control" placeholder="" name="name" value="${emp.name}" minlength="2" required>
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-3 control-label">密码</label>
								<div class="col-sm-7">
									<input type="password" class="form-control" placeholder="" id="password" name="password" value="${emp.password }" minlength="4" required>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-7">
									<input type="date" class="form-control" size="1" name="date"  value="${emp.birthday }">
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-3 control-label">联系方式</label>
								<div class="col-sm-7">
									<input type="text" class="form-control" placeholder="" name="telephone" value="${emp.telephone }">
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-3 control-label">邮箱</label>
								<div class="col-sm-7" >
									<input type="text" class="form-control" placeholder="" name="email" email="ture" value="${emp.email }" >
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-3 control-label">籍贯</label>
								<div class="col-sm-7">
									<input type="text" class="form-control" placeholder="" name="address" value="${emp.address }">
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-3 control-label">学历</label>
								<div class="col-sm-7">
									<input type="text" class="form-control" placeholder="" name="education" value="${emp.education }">
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-7">
									<select class="form-control m-b" name="departmentNumber" size="1" required>
										...
										<c:forEach items="${dlist }" var="d">
											<c:if test="${emp.department_number == d.department_number  }">
												<option value="${d.department_number }" selected>${d.name }</option>
											</c:if>
											<c:if test="${emp.department_number != d.department_number  }">
												<option value="${d.department_number }" selected>${d.name }</option>
											</c:if>
								...
								<div class="col-sm-7">
									<select class="form-control m-b" name="positionNumber" size="1" required>
										...
										<c:forEach items="${plist }" var="p">
											...
											<c:if test="${emp.position_number == p.position_number  }">
												<option value="${p.position_number }" selected>${p.name }</option>
											</c:if>
											<c:if test="${emp.position_number != d.position_number  }">
												<option value="${p.position_number }">${p.name }</option>
											</c:if>
										</c:forEach>
										<%-- <% 
