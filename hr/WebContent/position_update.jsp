			...
			<div class="col-sm-12">
				<div class="ibox float-e-margins">
					...
					<div class="ibox-content">
						...
						<form method="post" class="form-horizontal" id="commentForm" action="<%=path %>/#">
							<div class="form-group">
								<label class="col-sm-3 control-label">职称号</label>
								<div class="col-sm-7">
									<input type="text" class="form-control" name="positionNumber" value="" readonly="readonly">
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-sm-7">
									<input type="text" class="form-control" placeholder="" name="notes" value="#">
								</div>
							</div>
