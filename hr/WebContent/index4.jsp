	...
	<div id="wrapper">
				...
				<ul class="nav" id="side-menu">
					...
					<li>
                        ...
                        <ul class="nav nav-second-level">
                            <li><a class="J_menuItem" href="oneself_detail.jsp">查看个人信息</a>
                            </li>
                            <li><a class="J_menuItem" href="oneself_update.jsp">修改个人信息</a>
                            </li>
                        </ul>
                    </li>
                     <li class="hidden-folded padder m-t m-b-sm text-muted text-xs">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li><a class="J_menuItem" href="oneself_attendance.jsp">考勤记录</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                           <li><a class="J_menuItem" href="oneself_overtime.jsp">查看加班信息</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li><a class="J_menuItem" href="leave_add.jsp">申请请假</a>
                            </li>
                           <li><a class="J_menuItem" href="oneself_leave.jsp">请假记录</a>
                            </li>
                        </ul>
                    </li>
		...
		<div id="page-wrapper" class="gray-bg dashbard-1">
            ...
            <div class="row J_mainContent" id="content-main">
                <iframe id="J_iframe" name="J_iframe" width="100%" height="100%" src="welcome.jsp" frameborder="0" seamless></iframe>
            </div>
        </div>
		<!--右侧部分结束-->
	</div>
