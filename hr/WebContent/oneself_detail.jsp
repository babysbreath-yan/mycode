			...
			<div class="col-sm-12">
				<div class="ibox float-e-margins">
					...
					<div class="ibox-content">
						...
						<form method="post" class="form-horizontal" action="<%=path%>/empservlet?state=findallbypage">
						    <div class="form-group">
						    	<div class="col-md-1"></div>
								<div class="col-md-4">
							        <label class="col-sm-8 control-label">工号：</label>
							        <p class="form-control-static">${emp.employee_number}</p>
						   		</div>
						   		<div class="col-md-4">
							        <label class="col-sm-5 control-label">姓名：</label>
							        <p class="form-control-static">${emp.name}</p>
							    </div>
							</div>
							<div class="form-group">
						    	<div class="col-md-1"></div>
								<div class="col-md-4">
							       ...
							       <%--  <% String birthday = MTimeUtil.dateFormat(employee.getBirthday()); 	%> --%>
							        <p class="form-control-static">${emp.birthday }</p>
							    </div>
							</div>
							<div class="form-group">
								<div class="col-md-1"></div>
								<div class="col-md-4">
							        ...
							        <p class="form-control-static">${emp.telephone }</p>
						   		</div>
						   		<div class="col-md-4">
							...
							<div class="form-group">
								...
								<div class="col-md-4">
							        ...
							        <p class="form-control-static">${emp.address }</p>
						   		</div>
						   		<div class="col-md-4">
							        <label class="col-sm-5 control-label">学历：</label>
							        <p class="form-control-static">${emp.education }</p>
							    </div>
							</div>
							<div class="form-group">
						    	<div class="col-md-1"></div>
								<div class="col-md-4">
							        ...
							        <p class="form-control-static">${emp.department_number }</p>
						   		</div>
						   		<div class="col-md-4">
							        <label class="col-sm-5 control-label">职称：</label>
							        <p class="form-control-static">${emp.position_number }</p>
							    </div>
							</div>
							<div class="form-group">
						    	<div class="col-md-1"></div>
						    	<div class="col-md-4">
							        ...
							        <p class="form-control-static">${emp.in_time }</p>
						   		</div>
						   		<div class="col-md-4">
							        <label class="col-sm-5 control-label">备注：</label>
							        <p class="form-control-static">${emp.notes }</p>
						   		</div>
							</div>
							<div class="hr-line-dashed"></div>
							<div class="form-group">
								<div class="col-sm-4 col-sm-offset-8">
									<a href="<%=path%>/empservlet?state=findallbypage" class="btn btn-primary">修&nbsp;&nbsp;改</a>&nbsp;&nbsp;
									<a href="<%=path%>/welcome.jsp" class="btn btn-info">返&nbsp;&nbsp;回</a>
								</div>
							</div>
						</form>
					</div>
