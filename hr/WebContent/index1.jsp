                ...
                <%--    <% Employee employee = (Employee)session.getAttribute("loged"); %> --%>
					<li><a href="graph_metrics.html"> 
						...
						<ul class="nav nav-second-level">
							<li><a class="J_menuItem" href="#">查看个人信息</a>
							</li>
							<li><a class="J_menuItem" href="#">修改个人信息</a>
							</li>
					...
					<li><a href="graph_metrics.html">
						...
						<ul class="nav nav-second-level">
							<li><a class="J_menuItem" href="<%=path%>/empservlet?state=findallbypage">在职员工管理</a>
							</li>
					...
					<li><a href="#">
						...
						<ul class="nav nav-second-level">
							<li><a class="J_menuItem" href="<%=path %>/depservlet?state=findallbypage">部门管理</a>
							</li>
							<li><a class="J_menuItem" href="<%=path %>/posservlet?state=findallbypage">职称管理</a>
							</li>
						</ul>
					</li>
				</ul>
            ...
            <div class="row border-bottom">
                <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
                    ...
                    <ul class="nav navbar-top-links navbar-right">
                    	<li>欢迎：${emp.name}<%-- <%=employee.getName() %> --%>&nbsp;</li>
                        <li class="dropdown">
