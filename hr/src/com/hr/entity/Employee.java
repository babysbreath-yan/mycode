...
public Employee(int employee_number, String name, String gender, String birthday, String telephone, String email,
		String address, String photo, String education, int department_number, int position_number, String in_time,
...
public String toString() {
	return "Employee [id=" + id + ", employee_number=" + employee_number + ", name=" + name + ", gender="
			+ gender + ", birthday=" + birthday + ", telephone=" + telephone + ", email=" + email + ", address="
			+ address + ", photo=" + photo + ", education=" + education + ", department_number=" + department_number
			+ ", position_number=" + position_number + ", in_time=" + in_time + ", password=" + password + ", notes="
			+ notes + "]";
}
public Employee(int employee_number, String name, String gender, String birthday, String telephone, String email,
		String address, String education, int department_number, int position_number, String password, String notes) {
	super();
	this.employee_number = employee_number;
	this.name = name;
	this.gender = gender;
...
public Employee(int id, int employee_number, String name, String gender, String birthday, String telephone,
		String email, String address, String education, int department_number, int position_number, String password,
		String notes) {
	super();
	this.id = id;
	this.employee_number = employee_number;
