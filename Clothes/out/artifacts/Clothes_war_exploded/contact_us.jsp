...
<div class="mainContainer sixteen container">
        ...
        <header class="container">
            ...
            <nav id="smoothmenu1" class="ddsmoothmenu mainMenu">
                <ul id="nav">
                    ...
                    <li class="active"><a href="show_message.jsp" title="Footwear">留言板</a></li>
                </ul>
            </nav>
            ...
            <div class="mobMenu">
                ...
                <div id="menuInnner" style="display:none;">
                    <ul class="accordion">
                        <li class=""><a href="index.jsp" title="Home">首页</a></li>
                        <li class="parent"><a href="category.jsp" title="Shop by">全部商品</a>
    ...
    <section class="content-wrapper">
        <div class="content-container container">
            ...
            <div  class="col-main" action="contactServlet?tp=login">
